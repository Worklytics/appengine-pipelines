...
public class ShufflerServletTest {
  ...
  public void testDataIsOrdered() throws InterruptedException, IOException {
    ...
    JobId pipelineId= pipelineService.startNewPipeline(mr);
  ...
  List<KeyValue<ByteBuffer, List<ByteBuffer>>> validateOrdered(ShufflerParams shufflerParams, JobId pipelineId) throws IOException {
