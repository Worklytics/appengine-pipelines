 ...
 * {@link PipelineService#getJobInfo(JobId)}.
 * 
...
public interface JobInfo {
  ...
  static enum State {
    ...
    /**
     * Job was stopped through {@link PipelineService#stopPipeline(JobId)}.
     */
    STOPPED_BY_REQUEST, 
    /**
     ...
     * {@link PipelineService#cancelPipeline(JobId)} or due to unhandled
