...
public abstract class Marshaller<T> implements Serializable {
   ...
   * @return a new {@code ByteBuffer} {@code b} with a serialized representation
  ...
  /**
   * the object whose serialized representation is in {@code b} between
   ...
   *
   * @param b bytes (in buffer) to deserialize from
